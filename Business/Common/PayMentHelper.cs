    ...
    public class PayMentHelper
    {
        ...
        public void GetEnablePayNum()
        {
            ...
            if ((PaymentList.Online_EntityCard.ControlSwitch == BusinessEnum.ControlSwitch.Run) &&
                (CheckPaymentIsExist(BusinessEnum.PayMent.Online_EntityCard)))
            {
                intPayNum++;
            }
            ...
            if ((PaymentList.KimmaOnLineCard.ControlSwitch == BusinessEnum.ControlSwitch.Run) &&
                (CheckPaymentIsExist(BusinessEnum.PayMent.KimmaOnLineCard)))
            {
                intPayNum++;
            }
        ...
        public int GetOpenPayNum()
        {
            ...
            if (CheckPaymentIsExist(BusinessEnum.PayMent.Online_EntityCard))
            {
                intPayNum++;
            }
            ...
            if (CheckPaymentIsExist(BusinessEnum.PayMent.KimmaOnLineCard))
            {
                intPayNum++;
            }
        ...
        public BusinessEnum.PayMent GetOnlyOnePayment()
        {
            ...
            if ((PaymentList.Online_EntityCard.ControlSwitch == BusinessEnum.ControlSwitch.Run) &&
                (CheckPaymentIsExist(BusinessEnum.PayMent.Online_EntityCard)))
            {
                PaymentList.Now_PayMent = BusinessEnum.PayMent.Online_EntityCard;
                return PaymentList.Now_PayMent;
            }
            if ((PaymentList.UnionPay.ControlSwitch == BusinessEnum.ControlSwitch.Run) &&
                (CheckPaymentIsExist(BusinessEnum.PayMent.QuickPass)))
            ...
            if ((PaymentList.KimmaOnLineCard.ControlSwitch == BusinessEnum.ControlSwitch.Run) &&
                (CheckPaymentIsExist(BusinessEnum.PayMent.KimmaOnLineCard)))
            {
                PaymentList.Now_PayMent = BusinessEnum.PayMent.KimmaOnLineCard;
                return PaymentList.Now_PayMent;
            }
            if ((PaymentList.Volunteer_Code.ControlSwitch == BusinessEnum.ControlSwitch.Run) &&
                (CheckPaymentIsExist(BusinessEnum.PayMent.Volunteer)))
