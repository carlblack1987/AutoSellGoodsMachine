...
;                       break;
        ...
        public static BusinessEnum.PosBusiType ChangePosBusiType(string icBusiType)
        {
            ...
            switch (icBusiType)
            {
                ...
                case "2":// 长安通（不带网络）
                    ...
                    break;
                case "3":// 深圳达实POS
                    busiType = BusinessEnum.PosBusiType.SZDS;
                    break;
                case "4":// 金码标准协议POS
                    busiType = BusinessEnum.PosBusiType.KMT;
                    break;
                case "5":// 北京迪科POS
                    busiType = BusinessEnum.PosBusiType.BeiJingDiKe;
                    break;
                default:
        ...
        /// 转换扫描设备型号
        /// </summary>
        /// <param name="barCodeScanModel"></param>
        /// <returns></returns>
        public static BusinessEnum.BarCodeScanModel ChangeBarCodeScanModel(string barCodeScanModel)
        {
            BusinessEnum.BarCodeScanModel model = BusinessEnum.BarCodeScanModel.BarCode_XDL;
            switch (barCodeScanModel)
            {
                case "0":// 0 新大陆条形码扫描设备
                    model = BusinessEnum.BarCodeScanModel.BarCode_XDL;
                    break;
                case "1":
                    model = BusinessEnum.BarCodeScanModel.QrCode_XK;
                    break;
                default:
                    break;
            }
