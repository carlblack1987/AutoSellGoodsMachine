...
namespace Business.Common
{
    public class BarCodeHelper
    {
        ...
        private ScanType.ScanModel m_ScanModel_Fact = ScanType.ScanModel.BarCode_XDL;
        ...
        private string m_ScanModel = "0";
        /// <summary>
        /// 扫码类型
        /// </summary>
        public string ScanModel
        {
            get { return m_ScanModel; }
            set 
            { 
                if (value == "0")
                {
                    m_ScanModel_Fact = ScanType.ScanModel.BarCode_XDL;
                }
                if (value == "1")
                {
                    m_ScanModel_Fact = ScanType.ScanModel.QrCode_XK;
                }
            }
        }
        ...
        {
            m_ScanOper.Displose();
            m_ScanOper.ScanModel = m_ScanModel_Fact;
