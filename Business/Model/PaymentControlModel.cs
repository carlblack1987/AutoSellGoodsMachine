...
namespace Business.Model
{
    public class PaymentControlModel : PayMentInfoModel
    {
        ...
        public PaymentControlModel()
        {
            ...
            Online_EntityCard = new PayMentInfoModel();
            KimmaOnLineCard = new PayMentInfoModel();
            ...
            Online_EntityCard.Pic = "nofeecard.png";
            KimmaOnLineCard.Pic = "qrcodecard.png";
        }
        ...
        /// 在线会员实体RFID卡支付方式
        /// </summary>
        public PayMentInfoModel Online_EntityCard { get; set; }

        /// <summary>
        /// 在线会员实体RFID卡支付方式的类型
        /// </summary>
        public BusinessEnum.PayShowStatus PayShow_Online_EntityCard = BusinessEnum.PayShowStatus.Pause;

        /// <summary>
        /// 虚拟会员卡支付方式
        /// </summary>
        public PayMentInfoModel KimmaOnLineCard { get; set; }

        /// <summary>
        /// 虚拟会员卡支付方式的类型
        /// </summary>
        public BusinessEnum.PayShowStatus PayShow_KimmaOnLineCard = BusinessEnum.PayShowStatus.Pause;
