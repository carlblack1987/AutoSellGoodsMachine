...
namespace Business.Model
{
    public class DeviceInfoModel
    {
        ...
        public DeviceInfoModel()
        {
            ...
            OnlineEntityCardStatus = new DeviceStatusModel();
            OnlineEntityCardSoftVer = string.Empty;
            QrDeviceStatus = "01";
        ...
        /// 在线会员实体卡设备状态，默认正常（02）
        /// </summary>
        public DeviceStatusModel OnlineEntityCardStatus { get; set; }

        /// <summary>
        /// 在线会员实体卡备组件版本
        /// </summary>
        public string OnlineEntityCardSoftVer { get; set; }
