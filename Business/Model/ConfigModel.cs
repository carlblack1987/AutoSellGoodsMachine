...
namespace Business.Model
{
    public class ConfigModel
    {
        ...
        public ConfigModel()
        {
            ...
            GoodsUploadType = "0";
            PriceUploadType = "0";
            BarCodeScanModel = BusinessEnum.BarCodeScanModel.BarCode_XDL;
            IsUseCoin = BusinessEnum.ControlSwitch.Run;
            OnlineEntityCardDeviceType = BusinessEnum.OnlineEntityCardDeviceType.RFID_MW;
            OnlineEntityCardIsPwd = BusinessEnum.ControlSwitch.Stop;
            Manager1Purview = string.Empty;
        }
       ...
       /// 4：显示商品规格和生产厂家
        ...
        /// 扫描设备型号
        /// </summary>
        public BusinessEnum.BarCodeScanModel BarCodeScanModel { get; set; }

        /// <summary>
        /// 是否使用硬币 0：不使用 1：使用（默认）
        /// </summary>
        public BusinessEnum.ControlSwitch IsUseCoin { get; set; }

        /// <summary>
        /// 在线会员实体卡设备类型 1:RFID读卡设备—明威
        /// </summary>
        public BusinessEnum.OnlineEntityCardDeviceType OnlineEntityCardDeviceType { get; set; }

        /// <summary>
        /// 在线会员实体卡支付是否需要输入密码
        /// </summary>
        public BusinessEnum.ControlSwitch OnlineEntityCardIsPwd { get; set; }

        /// <summary>
        /// 机器配送员管理权限列表
        /// </summary>
        public string Manager1Purview { get; set; }
    } 
}
