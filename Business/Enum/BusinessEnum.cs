...
namespace Business.Enum
{
    public class BusinessEnum
    {
        ...
        public enum OperStep
        {
            ...
            Gift,// 礼品赠送
            OnlineEntityCard_Pwd,// 输入会员密码
            OnlineEntityCard_Post,// 在线会员实体卡提交支付
        }
        #endregion
        ...
        public enum ServerReason
        {
            ...
            Err_OnlineEntityCard,// 在线会员实体卡设备故障
        ...
        public enum PayMent
        {
            ...
            QuickPass,// 银联闪付
            Online_EntityCard,// 在线会员实体卡
            KimmaOnLineCard,// 在线会员虚拟卡
            IDCard,// 身份证
            Volunteer,// 志愿者兑换
        }
        ...
        {
            WuHanTong,// 1：武汉通
            XiAnTong_NoNet,// 2：长安通（不带网络）
            SZDS,// 3：深圳达实POS
            KMT,// 4：金码标准协议POS
            BeiJingDiKe,// 5 北京迪科POS
            Other,// 0：其它一卡通
        }
        ...
        /// 扫描设备型号
        /// </summary>
        public enum BarCodeScanModel
        {
            BarCode_XDL,// 新大陆条形码扫描设备
            QrCode_XK,// 北京象开二维码扫描设备
        }

        /// <summary>
        /// 在线会员实体卡设备类型
        /// </summary>
        public enum OnlineEntityCardDeviceType
        {
            RFID_MW,// RFID读卡设备—明威
        }
